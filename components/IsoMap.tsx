...
import { MapControls, Environment, Instance, Instances, Float, Outlines, OrthographicCamera } from '@react-three/drei';
...
// This handles both the legacy global JSX namespace and the React 18+ JSX namespace.
declare global {
  namespace JSX {
...
const IsoMap: React.FC<IsoMapProps> = ({ grid, onTileClick, hoveredTool, population }) => {
  ...
  return (
    <div className="absolute inset-0 bg-sky-900 touch-none">
      <Canvas shadows dpr={[1, 1.5]} gl={{ antialias: true, shadowMapType: THREE.PCFSoftShadowMap }}>
